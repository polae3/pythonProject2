...
URL(Uniform Resource Locator)
    ...
    ex) https://n.news.naver.com/article/366/0001038701?ntype=RANKING
...
경로(Path)
    웹서버에서 자원에 관한 경로(물리적 또는 추상적 경로
    ex) article/366/0001038701
...
import requests
# ?ntype=RANKING
url = 'https://n.news.naver.com/article/366/0001038701'
params = {
    'ntype:':'RANKING'
}
