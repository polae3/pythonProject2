...
#2. 튜플 슬라이싱
lengendary_birds = ('프리져', '썬더', '파이어', '루기아')
print('전설의 새:', lengendary_birds[1:3])
...
print('evolve_chain 주소값 2:', id(evolve_chain)) #리스트로 변환하여 수정하기는 하였으나 기존 튜플의 요소가 바뀐 게 아니라 새 튜플이 저장된 것.
